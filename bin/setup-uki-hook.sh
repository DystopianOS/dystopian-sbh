...
cat > /usr/lib/dystopian-sbh/generate-uki.sh << 'EOF'
#!/usr/bin/env bash
...
chmod +x /usr/lib/dystopian-sbh/generate-uki.sh

echo "✓ UKI generation script created: /usr/lib/dystopian-sbh/generate-uki.sh"

# Verify
ls -lh /etc/pacman.d/hooks/99-ukify-cachyos.hook
ls -lh /usr/lib/dystopian-sbh/generate-uki.sh
